...
### Changed
- Presiserer at YouTube-embeds skal bruke native player uten egendefinerte overlays som dekker videoen.

### Technical
- Version bump til 0.6.6
...
### Changed
- `blog-writing` krever nå at YouTube- og produktvideoer embeddes inline når publiseringsmålet støtter det
- 0-1-publiseringsreferansen presiserer at fallback-lenker ikke skal erstatte synlige embeds eller gjemmes i collapsed UI

### Technical
- Version bump til 0.6.5
...
### Changed
- `blog-writing` krever nå formatbrief før utkast: briefing, magasinformat, field guide, case, sammenligning, sjekkliste eller interaktiv forklaring
- Strengere redaksjonell gate for skannbarhet, konkrete eksempler, regnestykker og claim -> eksempel -> handling per seksjon
- 0-1-publiseringsreferansen åpner for postspesifikke MDX-moduler, video, diagrammer og generated illustrations når innlegget trenger eget uttrykk
- Norsk humanizer fanger nå filler-setninger, tomme superlativer og distansert leseromtale som "for norske ledere"

### Added
- `references/format-design.md` for Morning Brew/TLDR-rytme, visuelle moduler og final format-QA

### Technical
- Version bump til 0.6.4
...
### Added
- `blog-writing` — gjenbrukbar skill for norske blogginnlegg, SEO/AEO-subagent, konseptforklaringer, image-gen-plan og autonom publiseringspipeline for eide blogger
- Publiseringsreferanser for 0-1 og Companybook
- Norsk humanizer-reference inspirert av humanizer-prinsipper, tilpasset norsk business-tekst

### Changed
- Skills-katalogen oppdatert til 40 skills

### Technical
- Version bump til 0.6.3
